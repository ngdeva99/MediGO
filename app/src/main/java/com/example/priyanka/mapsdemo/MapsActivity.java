...
//changes made here
         ...
         final String loc = firebaseAuth.getInstance().getCurrentUser().getEmail().replace(".", "").substring(0, FirebaseAuth.getInstance().getCurrentUser().getEmail().indexOf('@'));
         //firebaseDatabase.getReference("Users/");

         //FirebaseDatabase.getInstance().getReference("Users").child(loc).setValue("dummy");
        ...
        if (firebaseAuth.getCurrentUser() != null) {
            ...
            Toast.makeText(MapsActivity.this, "Showing Nearby Locations", Toast.LENGTH_SHORT).show();
